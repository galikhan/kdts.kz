...
if ((isset($_SERVER['HTTP_X_REQUESTED_WITH'])) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')){
    ...
    if (isset($_POST['do']) && ($_POST['do'] == 'phone')) {
        ...
        echo json_encode(
            array(
                'success' => $success,
                'error' => $error,
                'msg' => '<p align="center" style="color:#fff;">Your application has been accepted, please wait for a call</p>',
            )
        );
    }
    ...
    if (isset($_POST['do']) && ($_POST['do'] == 'order')) {
        ...
        $sended = [
            'Single' => 'SINGLE',
            'Group' => 'GROUP',
            'Container train' => 'CONTAINER_TRAIN'
        ];
        ...
        if ($send){
            ...
            echo json_encode(
                array(
                    'success' => $success,
                    'error' => $error,
                    'msg' => '<p align="center" style="color:#fff;">Dear client, Good day!</p><p>&nbsp;</p><p align="center" style="color:#fff;">Thanks for your e-mail. Your request was successfully received. Our commercial offer will be provided to the specified e-mail. In case of any additional request, please do not hesitate to contact Call-center: +7 717 2 94 26 26.</p>',
                )
            );
        }else{
