	...
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                ...
                <li><a href="https://kdts.kz/klientterge/molsherlemeler-zhane-tarifter/">Қаз</a></li>
                <li><a href="https://kdts.kz/ru/klientam/stavki-i-tarify/"> Рус</a></li>
            </ul>
		</div>
    </div>
		<main>
								...
								echo '<div class="tarify-item">
										<a href="'.$blok["dokumenеt3"].'" download>
											<div class="tarify-item__photo">
												<img src="https://www.kdts.kz/img/tipovye-dogovora__icon.png"/>
												<p>'.$blok["tekst5"].'</p>
											</div>
								...
								echo '<div class="tarifnye-usloviya__item">
										<a href="'.$blok["dokumenеt6"].'" download>
											<div class="tarifnye-usloviya__photo">
												<img src="https://www.kdts.kz/img/tipovye-dogovora__icon.png" alt="#"/>
											</div>
