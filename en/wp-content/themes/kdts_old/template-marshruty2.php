...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/klientam/marshruty-perevozok/evropa-rossiya-cherez-rigu/', 'https') ?>">Eng </a></li>
                <li><a href="<? echo home_url('/klientterge/tasymaldaulardy-marshruttary/europa-resej-riga-arkyly/', 'https') ?>">Қаз</a></li>
