...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/klientam/marshruty-perevozok/suchzhou-varshava-polsha/', 'https') ?>">Eng</a></li>
                <li><a href="https://kdts.kz/klientterge/tasymaldaulardy-marshruttary/suchzhou-kytaj-varshava-polsha-2/">Қаз</a></li>
                <li><a href="https://kdts.kz/ru/klientam/marshruty-perevozok/suchzhou-varshava-polsha/">Рус</a></li>
            </ul>
		</div>
    </div>
     <main>
