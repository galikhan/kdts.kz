...
<?php get_header(); ?>
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/klientam/marshruty-perevozok/yoensuu-finlyandiya-korla-kitay/', 'https') ?>">Eng</a></li>
                <li><a href="https://kdts.kz/klientterge/tasymaldaulardy-marshruttary/joensuu-finlyandiya-korla-kytaj/">Қаз</a></li>
                <li><a href="https://kdts.kz/ru/klientam/marshruty-perevozok/yoensuu-finlyandiya-korla-kitay/">Рус</a></li>
            </ul>
		</div>
    </div>
       <main>
