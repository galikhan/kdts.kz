...
<?php get_header(); ?>
    <div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('o-kompanii/uslugi/fitingovykh-platform/', 'https') ?>">Eng</a></li>
                <li><a href="https://kdts.kz/kompaniya-turaly/kyzmetter/fitingtik-platformalar/">Қаз</a></li>
                <li><a href="https://kdts.kz/ru/o-kompanii/uslugi/fitingovykh-platform/">Рус</a></li>
            </ul>
		</div>
    </div>
	<main>
