...
<?php get_header(); ?>
		<div class="pagination-block">
			...
			<div class="yazyk">
				<ul>
					<li class="yazyk-active"><a href="<?php echo home_url('/klientam/marshruty-perevozok/evropa-tsentr-aziya-cherez-rigu/', 'https') ?>">Eng</a></li>
					<li><a href="https://www.kdts.kz/klientterge/tasymaldaulardy-marshruttary/europa-ortalyk-aziya-riga-arkyly/">Қаз</a></li>
					<li><a href="https://www.kdts.kz/ru/klientam/marshruty-perevozok/evropa-tsentr-aziya-cherez-rigu/">Рус</a></li>
				</ul>
			</div>
    	</div>
 	<main>
