...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/dopolnitelnaya-informatsiya/', 'https') ?>">Eng</a></li>
                <li><a href="https://www.kdts.kz/satyp-alul/dopolnitelnaya-informatsiya/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/ru/zakupki/dopolnitelnaya-informatsiya/">Рус</a></li>
            </ul>
		</div>
    </div>
