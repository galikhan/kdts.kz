...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/o-kompanii/partnery/"', 'https') ?>"> Eng</a></li>
                <li><a href="https://www.kdts.kz/kompaniya-turaly/seriktester/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/ru/o-kompanii/partnery/">Рус</a></li>
            </ul>
		</div>
    </div>
