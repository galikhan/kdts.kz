...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/tenders/odnogo-istochnika/', 'https') ?>">Eng</a></li>
                <li><a href="https://www.kdts.kz/satyp-alul/tender/bir-kozden-alu/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/ru/zakupki/tenders/odnogo-istochnika/">Рус</a></li>
            </ul>
		</div>
    </div>
