...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/arkhivy/tsenovykh/', 'https') ?>"> Eng</a></li>
                <li><a href="https://www.kdts.kz/satyp-alul/muragat/baga-usynystary/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/ru/zakupki/arkhivy/tsenovykh/">Рус</a></li>
            </ul>
		</div>
    </div>
