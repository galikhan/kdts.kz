...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/o-kompanii/rukovodstvo/', 'https') ?>">Eng </a></li>
                <li><a href="https://www.kdts.kz/kompaniya-turaly/basshyly/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/ru/o-kompanii/rukovodstvo/">Рус</a></li>
            </ul>
		</div>
    </div>
   <main>
            ...
            <article class="rukovodstvo-navbar">
                <div class="rukovodstvo-navbar__banner">
                    ...
                    <div class="rukovodstvo-navbar__banner-text">
                        <span> Schedule </span> <br/> of citizen reception
                    </div>
            ...
            <article class="rukovodstvo-content">
                <div class="rukovodstvo-onlayn">
                    <div class="rukovodstvo-onlayn__block">
                        <p class="rukovodstvo-onlayn__title"> Online application for admission to: </p>
