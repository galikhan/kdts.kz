	...
	<section class="zakupki-navbar">
       ...
       <section class="zakupki-content">
            ...
            <div class="zakupki-list__org">
                <p><span>Organizer:</span> AO "Kedentransservis" </p>
                <p><span>Way:</span> Open tender method </p>
                <p class="zakupki-list__start"><span>Start:</span> <? echo CFS()->get('data-nachalo'); ?> </p>
                <p class="zakupki-list__end"><span>Ending:</span> <? echo CFS()->get('data-okonchanie'); ?> </p>
            </div>
						...
						<?php foreach ($fields as $field) { ?>
							<div class="anti-download__item">
								...
								<div class="anti-download__item-text">
									...
									<p> (Exhibited: <? echo $field["data1"] ?>) </p>
								</div>
							</div>
						<?php }; ?>
					</div>
						...
						<?php foreach ($fields as $field) { ?>
							<div class="anti-download__item">
								...
								<div class="anti-download__item-text">
									...
									<p> (Exhibited: <? echo $field["data2"] ?>) </p>
								</div>
							</div>
						<?php }; ?>
					</div>
						...
						<?php foreach ($fields as $field) { ?>
							<div class="anti-download__item">
								...
								<div class="anti-download__item-text">
									...
									<p> (Exhibited: <? echo $field["data3"] ?>) </p>
								</div>
							</div>
						<?php }; ?>
					</div>
