...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/satyp-alul/zhyldyk-satyp-alu-zhospary/', 'https') ?>">Қаз</a></li>
                <li><a href="<? echo home_url('/ru/zakupki/godovoy-plan-zakupok/', 'https') ?>">Рус</a></li>
                <li><a href="<? echo home_url('/en/zakupki/godovoy-plan-zakupok/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
