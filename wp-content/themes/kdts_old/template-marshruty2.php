...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/klientterge/tasymaldaulardy-marshruttary/europa-resej-riga-arkyly/', 'https') ?>">Қаз</a></li>
                <li><a href="<?php echo home_url('/ru/klientam/marshruty-perevozok/evropa-rossiya-cherez-rigu/', 'https') ?>">Рус</a></li>
