	...
	<section class="zakupki-navbar">
       ...
       <section class="zakupki-content">
            ...
            <div class="zakupki-list__org">
                ...
                <p><span>Тәсілі:</span> Бір көзден алу тәсілімен </p>
                <p class="zakupki-list__start"><span>Басталуы:</span> <? echo CFS()->get('data-nachalo'); ?> </p>
                <p class="zakupki-list__end"><span>Аяқталуы:</span> <? echo CFS()->get('data-okonchanie'); ?> </p>
            </div>
