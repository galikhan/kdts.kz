...
<?php get_header(); ?>
    <div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/satyp-alul/grafik-provedeniya-tenderov/', 'https') ?>">Қаз</a></li>
                <li><a href="<? echo home_url('/ru/zakupki/grafik-provedeniya-tenderov/', 'https') ?>">Рус</a></li>
                <li><a href="<? echo home_url('/en/zakupki/grafik-provedeniya-tenderov/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
