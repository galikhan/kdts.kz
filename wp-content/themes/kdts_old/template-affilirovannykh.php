...
<?php get_header(); ?>
 	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/aktsionerlerge/kosylma-tylgalar-tizimi/', 'https') ?>">Қаз</a></li>
                <li><a href="<?php echo home_url('/ru/aktsioneram/spisok-affilirovannykh-lits/', 'https') ?>">Рус</a></li>
                <li><a href="<?php echo home_url('/en/aktsioneram/spisok-affilirovannykh-lits/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
