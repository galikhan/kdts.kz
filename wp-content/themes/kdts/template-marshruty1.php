...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/klientterge/tasymaldaulardy-marshruttary/suchzhou-kytaj-varshava-polsha/', 'https') ?>">Қаз</a></li>
                <li><a href="<?php echo home_url('/ru/klientam/marshruty-perevozok/suchzhou-kitay-varshava-polsha/', 'https') ?>">Рус</a></li>
                <li><a href="<?php echo home_url('/en/klientam/marshruty-perevozok/suchzhou-kitay-varshava-polsha/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
   <main>
