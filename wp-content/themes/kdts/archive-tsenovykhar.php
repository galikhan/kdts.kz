...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/satyp-alul/tender/baga-usynystary/', 'https') ?>">Қаз</a></li>
                <li><a href="<?php echo home_url('/ru/zakupki/arkhivy/tsenovykh/', 'https') ?>">Рус</a></li>
                <li><a href="<?php echo home_url('/en/zakupki/arkhivy/tsenovykh/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    	</div>
	...
	<section class="zakupki-navbar">
     ...
     <section class="zakupki-content">
            <h1 class="partnery-title">
                <?php echo CFS()->get('zagolovka',305); ?>
            </h1>
