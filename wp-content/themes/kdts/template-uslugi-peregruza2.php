...
<?php get_header(); ?>
    <div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/kompaniya-turaly/kyzmetter/zhuk-terminaldary/', 'https') ?>">Қаз</a></li>
                <li><a href="<? echo home_url('/ru/o-kompanii/uslugi/gruzovykh-terminalov/', 'https') ?>">Рус</a></li>
                <li><a href="<? echo home_url('/en/o-kompanii/uslugi/gruzovykh-terminalov/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
	<main>
