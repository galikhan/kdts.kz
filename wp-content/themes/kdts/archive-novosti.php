...
<?php get_header(); ?>
    <div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/zhanalyktar/', 'https') ?>">Қаз</a></li>
                <li><a href="<? echo home_url('/ru/novosti/', 'https') ?>">Рус</a></li>
                <li><a href="<? echo home_url('/en/novosti/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
