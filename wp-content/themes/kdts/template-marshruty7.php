...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/klientterge/tasymaldaulardy-marshruttary/joensuu-finlyandiya-korla-kytaj/', 'https') ?>">Қаз</a></li>
                <li><a href="<? echo home_url('/ru/klientam/marshruty-perevozok/yoensuu-finlyandiya-korla-kitay/', 'https') ?>">Рус</a></li>
                <li><a href="<? echo home_url('/en/klientam/marshruty-perevozok/yoensuu-finlyandiya-korla-kitay/', 'https') ?>">Eng</a></li>
            </ul>
		</div>
    </div>
       <main>
