...
<?php get_header(); ?>
		<div class="pagination-block">
			...
			<div class="yazyk">
				<ul>
					<li class="yazyk-active"><a href="<?php echo home_url('/klientam/marshruty-perevozok/evropa-tsentr-aziya-cherez-rigu/', 'https') ?>"> Рус</a></li>
					<li><a href="https://www.kdts.kz/klientterge/tasymaldaulardy-marshruttary/europa-ortalyk-aziya-riga-arkyly/">Қаз</a></li>
					<li><a href="https://www.kdts.kz/en/klientam/marshruty-perevozok/evropa-tsentr-aziya-cherez-rigu/">Eng</a></li>
				</ul>
			</div>
    	</div>
 	<main>
