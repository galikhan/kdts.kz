...
<?php get_header(); ?>
		<div class="pagination-block">
			...
			<div class="yazyk">
				<ul>
					<li class="yazyk-active"><a href="<?php echo home_url('/aktsioneram/vnutrennie-dokumenty/', 'https') ?>"> Рус</a></li>
					<li><a href="https://www.kdts.kz/aktsionerlerge/ishki-zhattar/">Қаз</a></li>
					<li><a href="https://www.kdts.kz/en/aktsioneram/vnutrennie-dokumenty/">Eng</a></li>
				</ul>
			</div>
    	</div>
