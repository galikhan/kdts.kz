...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/klientam/marshruty-perevozok/suchzhou-kitay-varshava-polsha/', 'https') ?>">Рус</a></li>
                <li><a href="https://www.kdts.kz/klientterge/tasymaldaulardy-marshruttary/suchzhou-kytaj-varshava-polsha/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/klientam/marshruty-perevozok/suchzhou-kitay-varshava-polsha/">Eng</a></li>
            </ul>
		</div>
    </div>
   <main>
