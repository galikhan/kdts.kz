...
<?php get_header(); ?>
  	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/aktsioneram/spisok-affilirovannykh-lits/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/aktsionerlerge/kosylma-tylgalar-tizimi/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/aktsioneram/spisok-affilirovannykh-lits/">Eng</a></li>
            </ul>
		</div>
    </div>
