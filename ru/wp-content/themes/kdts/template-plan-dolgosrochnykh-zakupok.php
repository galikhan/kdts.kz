...
<?php get_header(); ?>
    <div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/plan-dolgosrochnykh-zakupok/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/satyp-alul/uzak-merzimdi-satyp-alu-zhospary/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/zakupki/plan-dolgosrochnykh-zakupok/">Eng</a></li>
            </ul>
		</div>
    </div>
