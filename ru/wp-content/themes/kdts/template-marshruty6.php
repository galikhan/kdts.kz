...
<?php get_header(); ?>
		<div class="pagination-block">
			...
			<div class="yazyk">
				<ul>
					<li class="yazyk-active"><a href="<?php echo home_url('/klientam/marshruty-perevozok/kitay-evropa/', 'https') ?>">Рус</a></li>
					<li><a href="https://www.kdts.kz/klientterge/tasymaldaulardy-marshruttary/kytai-europa/">Қаз</a></li>
					<li><a href="https://www.kdts.kz/en/klientam/marshruty-perevozok/kitay-evropa/">Eng</a></li>
				</ul>
			</div>
		</div>
       <main>
