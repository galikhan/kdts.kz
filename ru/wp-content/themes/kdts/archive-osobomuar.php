...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/arkhivy/osobomuar/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/kz/zakupki/arkhivy/osobomuar/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/zakupki/arkhivy/osobomuar/">Eng</a></li>
            </ul>
		</div>
    </div>
