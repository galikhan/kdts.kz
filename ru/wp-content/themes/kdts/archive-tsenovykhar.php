...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/arkhivy/tsenovykh/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/satyp-alul/muragat/baga-usynystary/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/zakupki/arkhivy/tsenovykh/">Eng</a></li>
            </ul>
		</div>
    </div>
