...
/****************************/
function Obyavleniya_create_post_type() {
	register_post_type( 'obyavleniya',
		array(
			'labels' => array(
				'name' => __('Объявления'),
				'singluar_name' => __('obyavleniya'),
				'add_new' => 'Добавить объявления',
			),
			'public'             => true,
		'publicly_queryable' => true,
		'show_ui'            => true,
...
add_action('init', 'Obyavleniya_create_post_type');
/****************/
...
function Tsenovykh_predlozheniy_create_post_type() {
	register_post_type( 'tsenovykh',
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/tenders/tsenovykh','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Po_osobomu_poryadku_create_post_type() {
	register_post_type( 'osobomu',
		array(
			'labels' => array(
				'name' => __('Закупки по особому порядку'),
				'singluar_name' => __('osobomu'),
				'add_new' => 'Добавить',
			),
		'public'             => true,
		'publicly_queryable' => true,
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/tenders/osobomu','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
add_action('init', 'Po_osobomu_poryadku_create_post_type');
...
function Tsenovykhar_predlozheniy_create_post_type() {
	register_post_type( 'tsenovykhar',
		array(
			'labels' => array(
				'name' => __('Архив ценовых предложений'),
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/arkhivy/tsenovykh','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Otkrytogo_predlozheniy_create_post_type() {
	register_post_type( 'otkrytogo',
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/tenders/otkrytogo-tendera','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Otkrytogoar_predlozheniy_create_post_type() {
	register_post_type( 'otkrytogoar',
		array(
			'labels' => array(
				'name' => __('Архив открытого тендера'),
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/arkhivy/otkrytogo-tendera','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Odnogo_istochnika_create_post_type() {
	register_post_type( 'odnogo',
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/tenders/odnogo-istochnika','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Odnogoar_istochnika_create_post_type() {
	register_post_type( 'odnogoar',
		array(
			'labels' => array(
				'name' => __('Архив одного источника'),
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/arkhivy/odnogo-istochnika','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Dvukhetapnogo_tendera_create_post_type() {
	register_post_type( 'dvukhetapnogo',
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/tenders/dvukhetapnogo-tendera','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
...
function Dvukhetapnogoar_tendera_create_post_type() {
	register_post_type( 'dvukhetapnogoar',
		array(
			'labels' => array(
				'name' => __('Архив двухэтапного тендера'),
		...
		'show_in_menu'       => true,
		'query_var'          => true,
		'rewrite' => array('slug' => 'zakupki/arkhivy/dvukhetapnogo-tendera','with_front' => false),
		'capability_type'    => 'post',
		'has_archive'        => true,
		'hierarchical'       => false,
		'menu_position'      => null,
