...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/klientam/park-platform-i-konteynerov/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/klientterge/platformalar-parki/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/klientam/park-platform-i-konteynerov/">Eng</a></li>
            </ul>
		</div>
    </div>
 	<main>
