...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/aktsioneram/godovaya-i-finansovaya-otchetnost/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/aktsionerlerge/zhyldy-zh-ne-arzhy-eseptiligi/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/aktsioneram/godovaya-i-finansovaya-otchetnost/">Eng</a></li>
            </ul>
		</div>
    </div>
