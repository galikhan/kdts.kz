...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/tenders/odnogo-istochnika/', 'https') ?>"> Рус</a></li>
                <li><a href="https://www.kdts.kz/satyp-alul/tender/bir-kozden-alu/">Қаз</a></li>
                <li><a href="https://www.kdts.kz/en/zakupki/tenders/odnogo-istochnika/">Eng</a></li>
            </ul>
		</div>
    </div>
