...
<?php get_header(); ?>
    <div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/o-kompanii/uslugi/dostyk-i-altynkol/"', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/kompaniya-turaly/kyzmetter/dostyk-i-altynkol/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/o-kompanii/uslugi/dostyk-i-altynkol/">Eng</a></li>
            </ul>
		</div>
    </div>
	<main>
