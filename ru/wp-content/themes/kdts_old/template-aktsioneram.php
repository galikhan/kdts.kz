...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/aktsioneram/', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/aktsionerlerge/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/aktsioneram/">Eng</a></li>
            </ul>
		</div>
    </div>
	 <main>
