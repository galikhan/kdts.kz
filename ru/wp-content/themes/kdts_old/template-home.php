				...
				<div class="header-left">
					<div class="header-logo">
						<a href="<? echo home_url() ?>">
                            <img src="https://kdts.kz/wp-content/themes/kdts/img/Group4444446666.png"/>
                        </a>
					</div>
					<nav class="nav-menu">
						<?php wp_nav_menu ( array (
...
<div class="main-container">
					...
					<div class="footer-block__bottom">
						<div class="container-footer">
							<div class="footer-items">
								<p class="footer-name">1997- 2021, АО «Кедентранссервис»</p>
	...
	<div class="modal-overlay">
		<div class="arPortfolioModal" data-target="arPortfolioItem1">
			<p class="arPortfolioModal-title">Оставить заявку</p>
