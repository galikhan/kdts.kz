...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/o-kompanii/istoriya-kompanii/', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/kompaniya-turaly/kompaniyanyn-tarihy/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/o-kompanii/istoriya-kompanii/">Eng</a></li>
            </ul>
		</div>
    </div>
 <main>
