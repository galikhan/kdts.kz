...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<? echo home_url('/o-kompanii/', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/kompaniya-turaly/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/o-kompanii/">Eng</a></li>
            </ul>
		</div>
    </div>
   <main>
        <div class="container-rukovodstvo">
            <div class="rukovodstvo-top">
                ...
                <section class="rukovodstvo-content">
                    ...
                    <div class="years">
                      	 Cвыше <span class="years-number"> 20 </span>лет на рынке 
                    </div>
			...
			<div class="abount-missiya__container">
				<div class="abount-predstavitelstva__block">
					...
					<div class="abount-predstavitelstva__block_items">
						...
						<? $predstavitelstva = CFS()->get('predstavitelstva-loop');
