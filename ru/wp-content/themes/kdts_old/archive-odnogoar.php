...
<?php get_header(); ?>
	...
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/arkhivy/odnogo-istochnika/', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/satyp-alul/muragat/bir-kozden-alu/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/zakupki/arkhivy/odnogo-istochnika/">Eng</a></li>
            </ul>
		</div>
    </div>
