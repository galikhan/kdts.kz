...
<?php get_header(); ?>
	...
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/klientam/marshruty-perevozok/yoensuu-finlyandiya-korla-kitay/', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/klientterge/tasymaldaulardy-marshruttary/joensuu-finlyandiya-korla-kytaj/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/klientam/marshruty-perevozok/yoensuu-finlyandiya-korla-kitay/">Eng</a></li>
            </ul>
		</div>
    </div>
      <main>
