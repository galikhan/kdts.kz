...
<?php get_header(); ?>
	<div class="pagination-block">
		...
		<div class="yazyk">
			<ul>
                <li class="yazyk-active"><a href="<?php echo home_url('/zakupki/godovoy-plan-zakupok/', 'https') ?>"> Рус</a></li>
                <li><a href="https://kdts.kz/satyp-alul/zhyldyk-satyp-alu-zhospary/">Қаз</a></li>
                <li><a href="https://kdts.kz/en/zakupki/godovoy-plan-zakupok/">Eng</a></li>
            </ul>
		</div>
    </div>
